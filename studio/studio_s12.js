...
function detect_undeclared_names(xs) {
    display(xs);
    display(scan_out_declarations(xs));
}
...
function eval_sequence(stmts, env) {
    stmts = reorder_statements(stmts);
...
function parse_and_evaluate(program) {
    return evaluate(make_block(detect_undeclared_names(parse(program))), 
